...
export class WesjetInstallNative extends BaseCommand {
  ...
  executeSafe = () => {
    ...
    return pipe(
      ...
      OT.withSpan('wesjet/cli/commands/WesjetInstallNative:executeSafe', {
...
/**
* This file is automatically generated by @Wesjet
*
