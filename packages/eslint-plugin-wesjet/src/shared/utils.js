...
exports.metaDocsUrl = (name) =>
  `https://github.com/wesbitty/wesjet/blob/${version}/packages/eslint-plugin-wesjet/docs/rules/${name}.md`
...
exports.getParserServices = (context) => {
  if (
    ...
    throw new Error('This rule requires you to use `eslint-plugin-wesjet/parser`.')
  }
