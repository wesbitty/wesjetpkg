import { createRule } from '../shared/createRule'
import * as path from 'path'
import * as fs from 'fs'
import { fetchRootDirs } from '../shared/fetchRootDir'

import { getUrlFromPagesDirectories, normalizeURL, execOnce } from '../shared/url'
...
export = createRule({
  ...
  create(context) {
    ...
    const rootDirs = fetchRootDirs(context)
