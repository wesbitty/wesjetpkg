...
import type { E, HasClock, HasConsole } from '@wesjet/function.js/effect'
import { Array, Chunk, flow, OT, pipe, S, T } from '@wesjet/function.js/effect'
...
import type { SourceProvideSchemaError } from './WesjetPackageErrors.js'
import type { Config } from './WesjetPackageConfig.js'
import type { SourceFetchDataError } from './index.js'
import type { PluginOptions, SourcePluginType } from './WesjetPlugin.js'
import type { DocumentTypeDef, SchemaDef } from './WesjetSchema.js'
import { autogeneratedNote } from './WesjetPluginNote.js'
import { renderTypes } from './types/generate-types.js'
...
const writeFileWithWrittenFilesCache =
  ...
  ({
    ...
    content: string
    documentHash?: string
    /** In order for VSC to pick up changes in compiled files, it's currently needed to delete the file before re-creating it */
