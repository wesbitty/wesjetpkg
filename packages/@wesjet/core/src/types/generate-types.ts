...
import type { GenerationOptions } from '../WesjetPackageGen.js'
import type { SourcePluginType } from '../WesjetPlugin.js'
...
export type NestedTypeNames = ${
    nestedTypes.length > 0 ? renderUnion(nestedTypeNames.map(wrapInQuotes)) : 'never'
  }
